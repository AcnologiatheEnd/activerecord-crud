...
def can_be_found_updated_and_saved
  ...
  inst = Movie.find_by(title: "Awesome Flick")
  inst.update(title: "Even Awesomer Flick")
  inst.save
end
...
def can_update_using_update_method
  ...
  inst = Movie.find_by(title: "Wat?")
  inst.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once").destroy_all
  __
end
